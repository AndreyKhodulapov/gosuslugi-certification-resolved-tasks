...
### 1. Отчет по брендам в магазине детских товаров
...
### 2. Анализ активности сотрудников техподдержки
Сложный
Вложенные запросы
Вывод данных
Фильтрация
...
### 4. Анализ продаж по категориям товаров в розничном магазине
...
### 5. Анализ посещаемости фитнес-клубов
...
### 6. Максимальный средний вес товара
Описание:
...
### 8. AЛЬТЕРНАТИВНОЕ РЕШЕНИЕ С ОКОННОЙ ФУНКЦИЕЙ
